(function(app) {
    'use strict';
    app.controller('rekrutmenPsikotesMulaiController',
        function ($window, $scope, $http, $state, authService, localStorageService, swalAlert, $cookies) {
            ...
            */
            ...
            // #region pertanyaan 1
            $scope.changeRow1 = function() {
                if ($scope.row1 == $scope.row2) $scope.row2 = undefined;
                if ($scope.row1 == $scope.row3) $scope.row3 = undefined;
                if ($scope.row1 == $scope.row4) $scope.row4 = undefined;

                if (($scope.row1 && $scope.row2) ||
                    ($scope.row1 && $scope.row3) ||
                    ($scope.row1 && $scope.row4) ||
                    ($scope.row2 && $scope.row3) ||
                    ($scope.row2 && $scope.row4 ||
                    ($scope.row4 && $scope.row3))) {
